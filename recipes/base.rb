...
bash 'build' do
  ...
  code <<-EOB
      ...
      ln -sv $GOPATH/bin/amqp-consume-cat #{node['install_prefix']}/bin/amqp-consume-cat
      ln -sv $GOPATH/bin/amqp-publish-files #{node['install_prefix']}/bin/amqp-publish-files
